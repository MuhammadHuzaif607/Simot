    ...
    <div className="flex-col text-white text-center">
      <div className="grid md:grid-cols-4 grid-cols-1 gap-4 mb-6">
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            ...
            <h3 className="text-2xl font-bold">{formatMoney(totalInventoriesPrice)}</h3>
          </div>
        </div>
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
      ...
      <div className="grid md:grid-cols-4 grid-cols-1 gap-4 mb-6">
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            ...
            <h3 className="text-2xl font-bold">{formatMoney(technicianYearlyCost)}</h3>
          </div>
        </div>
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            <p>technician cost of the month</p>
            <h3 className="text-2xl font-bold">{formatMoney(technicianMonthlyCost)}</h3>
          </div>
        </div>
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            <p>net total for the year</p>
            <h3 className="text-2xl font-bold">{formatMoney(yearlyNetTotal)}</h3>
          </div>
        </div>
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            <p>net total for the month</p>
            <h3 className="text-2xl font-bold">{formatMoney(monthlyNetTotal)}</h3>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-4 grid-cols-1 gap-4 mb-6">
        ...
        <div className="dashboard-box p-4 flex items-center justify-center">
          <div>
            <p>Sales this year</p>
            <h3 className="text-2xl font-bold">{formatMoney(salesThisMonth)}</h3>
          </div>
        </div>
      </div>
